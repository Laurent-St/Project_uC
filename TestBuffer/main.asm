...
RJMP noKeyboard
Pressed8: LDI R23,0x8
RJMP noKeyboard
Pressed7: LDI R23,0x7
RJMP noKeyboard

CPressed: LDI R23,0xC
RJMP noKeyboard
BPressed: LDI R23,0xB
RJMP noKeyboard
Pressed0: LDI R23, 0x0
RJMP noKeyboard
APressed: LDI R23,0xA
RJMP noKeyboard
DPressed: LDI R23,0xD
RJMP noKeyboard
...
RJMP noKeyboard
EPressed: LDI R23,0xE
RJMP noKeyboard
Pressed6: LDI R23,0x6
RJMP noKeyboard
Pressed5: LDI R23,0x5
RJMP noKeyboard
FPressed: LDI R23,0xF
RJMP noKeyboard
Pressed9: LDI R23,0x9
RJMP noKeyboard
;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

noKeyboard: ;thus here X=0x200
ADD XL,R23 ;add the value of R23 to X to change at its position
BRCC nocarry3
LDI R23,0x01
ADD XH,R23 ;if there is a carry
nocarry3:
